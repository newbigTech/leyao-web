    ...
    <card-panel>
      ...
      <div slot="panel-body">
        <div class="_magic-card">
          ...
          <div class="_table-magic-setting">
            <ul v-for="(ul, i) in trs3">
              <li v-for="(li, ii) in ul" @mouseenter="liMouseenter(li)" :class="{'selected': li.selected}" :data-x="li.x" :data-y="li.y"></li>
            </ul>
          </div>
        </div>
      </div>
