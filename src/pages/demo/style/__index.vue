...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getSubArrayByIndex(x, y, arr2, direction = true) {
      ...
      tdClick(td) {
        let s = this.getSubArrayByIndex(td.x, td.y, this.trs, this.clicked)
        let locks = []
        s.forEach(s => {
          let _a = []
          s.forEach(ss => { 
