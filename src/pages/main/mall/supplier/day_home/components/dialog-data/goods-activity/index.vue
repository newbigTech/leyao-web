            ...
            <div class="_query-form">
                <div class="_query-form-item">
                    <el-form :inline="true" :model="activityParams" class="demo-form-inline">
                        <el-form-item>
                            <el-input v-model="activityParams.activityName" placeholder="活动名称" :maxlength="20"></el-input>
                        </el-form-item>
                        <el-form-item>
                            <el-select v-model.number="activityParams.activityType" placeholder="活动类型" clearable>
                                <el-option label="特价" :value="1"></el-option>
