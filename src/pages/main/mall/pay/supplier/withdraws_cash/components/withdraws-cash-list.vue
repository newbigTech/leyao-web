      ...
      <div class="_table-container">
        <div class="_table-list">
            <el-table :data="withdrawsData" style="width: 100%" border>
                ...
                <el-table-column property="accountNo" label="帐号" width="220" align="center"> </el-table-column>
...
<script>
  ...
  import { _getWithdrawRecordPage } from 'src/vuex/actions/payAction'
  ...
  export default {
    ...
    methods: {
      ...
      searchTableList() {
        ...
        _getWithdrawRecordPage(tempParams).then(data => {
      ...
      exportCurrentPage(){
        ...
        tempParams.pageNo = this.page
        tempParams.pageSize = this.pageSize
        location.href='/pay/mallExportPayController/exportWithdrawRecordList?'+$.param(tempParams) ;
      },
      // 导出所有
      exportAllPage(){
        let tempParams = this.initParams() ;
