    ...
    <div class="_container"> 
      ...
      <div class="_setting-options">
        <div class="_setting-options-left">
          ...
          <el-form-item>
            <el-select v-model="transactionModel.settleStatus" placeholder="结算状态" clearable>
                <el-option label="待结算" value="WAIT_SETTLE"></el-option>
      ...
      <div class="_table-container">
        <div class="_table-list">
            <el-table :data="transactionData" style="width: 100%" border>
                <el-table-column fixed type="index" width="80" align="center"></el-table-column>
                <el-table-column fixed property="merchantOrderNo" label="订单号" width="250"></el-table-column>
                ...
                <el-table-column inline-template label="交易类型" width="120"> 
                     <div>
                ...
                <el-table-column inline-template label="结算状态" width="120">
                     <div>
                      <span v-if="row.settleStatus == 'WAIT_SETTLE'">待结算</span>
                      <span v-if="row.settleStatus == 'SETTLED'">已结算</span>
                    </div>
                </el-table-column>                
                <el-table-column inline-template label="订单状态" width="120">
                    <div>
                ...
                <el-table-column fixed="right" inline-template label="操作" width="190"> 
                  <div>
                      ...
                      @click.native.prevent="$emit('forward', 'transactionListDetail', row)">支付详情</el-button>   <el-button type="primary" size="small"
...
<script>
  ...
  import { _getShopTransactionListPage } from 'src/vuex/actions/payAction'
    ...
    methods: {
      initParams(){
        ...
        let params = {
          ...
          settleStatus:this.transactionModel.settleStatus,
      ...
      searchTableList() {
        ...
        _getShopTransactionListPage(tempParams).then(data => {
      ...
      onViewOrder(item) {
            let params = {
                ...
                urlPathName:'transaction_shop_record',
                r: _.toNumber(_.now())
            }
      ...
      exportCurrentPage(){
        ...
        tempParams.pageNo = this.page
        tempParams.pageSize = this.pageSize
        location.href='/pay/mallShopExportPayController/exportTransactionList?'+$.param(tempParams) ;
      },
      // 导出所有
      exportAllPage(){
        let tempParams = this.initParams() ;
