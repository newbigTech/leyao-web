...
<div class="_container">
    ...
    <div class="_query-form">
      <div class="_query-form-item">
        <el-form :inline="true">
          ...
          <el-form-item>
            <el-input placeholder="充值人手机号查询" v-model="userMobileSearch"></el-input>
          </el-form-item>
          <el-form-item>
            <el-input placeholder="充值人用户名查询" v-model="userAliasSearch"></el-input>
          </el-form-item>
          <el-form-item>
            <el-input placeholder="充值人姓名查询" v-model="realNameSearch"></el-input>
          </el-form-item>
          <el-form-item>
  ...
  <div class="_table-container">
    <div class="_table-list">
        ...
        <el-table-column align="center" property="goodsName" label="充值商品名称" width="180" sortable="'custom'"></el-table-column>
        <el-table-column align="center" property="userMobile" label="充值人手机号" width="150" sortable="'custom'"></el-table-column>
        <el-table-column align="center" property="userAlias" label="充值人用户名" width="150" sortable="'custom'"></el-table-column>
        <el-table-column align="center" property="realName" label="充值人姓名" width="150" sortable="'custom'"></el-table-column>
