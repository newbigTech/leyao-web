...
import roleList from "./roleMng/roleList"
import roleAdd from "./roleMng/roleAdd"
import roleModify from "./roleMng/roleModify"
import roleDetail from "./roleMng/roleDetail"
import rolePermission from "./roleMng/rolePermission"
import roleUser from "./roleMng/roleUser"

export default {
    name: 'mall_basic_role',
    ...
    created() {
       ...
       this.obj= {companyId : this.supplierID,companyType : 0}
    }
}
</script>
<style lang="sass">
