<template>
  <div class="shop_custom_classify">
    ...
    <!-- <keep-alive> -->
    <component :is="currentComponent" :obj="obj" :shop-update-param="shopUpdateParam" @forward="forward" @reback="reback"></component>
    <!-- </keep-alive> -->
    <!-- </transition> -->
  </div>
</template>
<script>
 ...
 import orderList from "./order_index"
