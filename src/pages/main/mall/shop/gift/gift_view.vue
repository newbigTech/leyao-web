            ...
            <div slot="panel-body">
                <el-form :model="giftObj" :rules="rules" ref="giftObj" label-width="150px">
                    <el-form-item label="商品名称" prop="goodsName">
                        <el-input v-model="giftObj.goodsName" :maxlength="50" style="width:330px"></el-input>
                    </el-form-item>
                    <el-form-item label="商品类型">
                        <el-input v-model="giftObj.classifyName" :maxlength="20" style="width:330px" readonly></el-input>
                    </el-form-item>
                    <el-form-item label="商品全称">
                        <el-input v-model="giftObj.goodsFullName" :maxlength="150" placeholder="商品全称" style="width:330px"></el-input>
                    </el-form-item>
                    <el-form-item label="商品简介">
                        <el-input type="textarea" v-model="giftObj.goodsDesc" :maxlength="500" placeholder="商品简介" style="width:330px"></el-input>
                    </el-form-item>
                    <el-form-item label="商品编号">
                        <el-input v-model="giftObj.goodsSn" :maxlength="20" style="width:330px"></el-input>
                    </el-form-item>
...
export default {
    ...
    created() {
        if (this.paramObj.goodsId) {
            ...
            Object.assign(this.giftObj, _.pick(this.paramObj, ['goodsId','goodsName', 'goodsFullName', 'classifyId', 'classifyName', 'goodsPic', 'goodsDesc', 'goodsSn', 'unit', 'marketPrice', 'stockNumber', 'sortIndex']))

            if(this.paramObj.goodsPics.length>1){
            ...
            if(this.paramObj.strVal1.length>1){
