<template>
  <div class="_tree-box">
    <div class="_tree-header">
      <h3>商品分类管理</h3>
      <div>
        <button class="btn btn-sm btn-success" style="padding: 3px 10px;" @click="add" v-if="type !== 'treeSelect'">新增</button>
        <button class="btn btn-sm btn-danger" style="padding: 3px 10px;" @click="remove" v-if="type !== 'treeSelect'">删除</button>
      </div>
    </div>
