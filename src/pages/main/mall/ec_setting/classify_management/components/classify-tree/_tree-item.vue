<template>
  <li class="_tree-item" :class="[{'_open': open}, checkedState]" :state="this.model.checked">
    ...
    <div class="_tree-item-bar" href="#">
      ...
      <a href="javascript:;" class="_tree-item-a" @click.prevent="treeClick($event, 'checked')" :class="{'active': type == 'treeSelect' ? false : initClassify.classifyId == this.model[id]}">
    ...
    methods: {
      ...
      treeClick(ev, type) { 
        if (this.type !== 'treeSelect') {
          ...
          // console.log({ name: this.model.name, cid: this.model.cid, parentId: this.model.parentId })
          this.e.$emit('treeClick', { [this.label]: this.model[this.label], [this.id]: this.model[this.id], parentId: this.model.parentId, tree: this.dd })
          // console.log(this.$el)
        ...
        if (this.type == 'treeSelect') {
          ...
          this.e.$emit('treeCheck', { name: this.model.name, cid: this.model.cid, parentId: this.model.parentId, tree: this.dd })
        }
      ...
      rename() {
        ...
        .then( ({ value }) => {
          console.log("rename: ", { name: value, cid: this.model.cid, parentId: this.model.parentId })
          // this.$emit("treeRename", { name: value, cid: this.model.cid, parentId: this.model.parentId })
          // this.$root.$emit("treeRename", { name: value, cid: this.model.cid, parentId: this.model.parentId })
          this.e.$emit("treeRename", { name: value, cid: this.model.cid, parentId: this.model.parentId, tree: this.d })
      ...
      add(type) {
        ...
        .then(({ value }) => {
          console.log("add",{ name: value, cid: this.model.cid, parentId: this.model.parentId })
          // this.$emit('treeAdd', { name: value, cid: this.model.cid, parentId: this.model.parentId })
          // this.$root.$emit('treeAdd', { name: value, cid: this.model.cid, parentId: this.model.parentId })
          this.e.$emit('treeAdd', { name: value, cid: this.model.cid, parentId: this.model.parentId, tree: this.d })
        })
        .catch(() => {})
      },
      remove() {
        ...
        .then(() => {
          // console.log("remove", { name: this.model.name, cid: this.model.cid, parentId: this.model.parentId})
          // this.$emit('treeRemove', { name: this.model.name, cid: this.model.cid, parentId: this.model.parentId})
          // this.$root.$emit('treeRemove', { name: this.model.name, cid: this.model.cid, parentId: this.model.parentId})
          this.e.$emit('treeRemove', { name: this.model.name, cid: this.model.cid, parentId: this.model.parentId, tree: this.dd})
        })
        .catch(() => {
          // 取消
        })
