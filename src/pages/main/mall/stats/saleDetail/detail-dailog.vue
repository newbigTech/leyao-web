    ...
    <div class="_table-container"> 
        <div class="_table-list">
          <el-table :data="dataList" stripe style="width: 100%" border @sort-change="changeSort">
            <el-table-column fixed align="center" property="orderNo" label="订单号" width="210" sortable="'custom'"></el-table-column>
          	<el-table-column fixed type="expand">
				      <template scope="props">
			            ...
			            <el-table-column align="left" label="所属分类" width="150">
			            	<template scope="scope">
			            		<span>{{scope.row.classifyName || (scope.row.classifyId+'')}}</span>
			            	</template>
			            </el-table-column>
			            ...
			            <el-table-column align="right" label="金额占比" width="100">
			            	<template scope="scope">
			            		<span>{{(scope.row.goodsRate*100).toFixed(2)}}%</span>
			            	</template>
			            </el-table-column>
  ...
  export default{
    ...
    data() {
      ...
      return {
        ...
        orderType: typeof _this.parentObj.orderType=='undefined'? -1:_this.parentObj.orderType,
        payStatus:-1,
        lastDate:lastDay,
        pickerOptions0: {
        	disabledDate(time){
        ...
        payStatusList:[//-1支付状态 0 未支付 1 已支付
        	{value: -1,label: '支付状态'},
        	{value: 0,label: '未支付'},
        	{value: 1,label: '已支付'},
        ],
    ...
    methods:{
      loadData(){
        ...
        this.loading = true;
        getSaleDetailList(param).then((data) => {
          this.loading = false;
